...
class FormatService
{
    // introduce map of widely used or known formats?
    ...
    // - match format strings with suffixes like +xml/+json to their base media types if no formats match

    protected $formats = array();

    public function registerFormat(IFormat $format)
    {
    ...
    public function getFormat($identifier)
    {
        if (array_key_exists($identifier, $this->formats)) {
